    ...
    try:
        ...
        if payload.get("ref") == "refs/heads/main":
            ...
            result = subprocess.run(
                ["/home/deployments/webhook-handler.sh"], capture_output=True, text=True
            )
            ...
            if result.returncode == 0:
                ...
                return HttpResponse("Deployment failed", status=500)

        return HttpResponse("Webhook received but not a main branch push", status=200)
